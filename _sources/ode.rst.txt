...
in terms of the infinitesimal generator of a transitive group action :math:`\psi`, as described in the section `Algorithms <https://leoneandrea.github.io/Quadrotors/int.html>`_.
This is the formalism also used in the  `main code <https://github.com/LeoneAndrea/Quadrotors/blob/main/src/main.m>`_. 
